...
class VisitorLoginView: UIView {
    ...
    private func setupUI() {
        ...
        // 设置背景视图的约束
//        addConstraint( NSLayoutConstraint(item: discoverMaskView, attribute: .centerX, relatedBy: .equal, toItem: circleView, attribute: .centerX, multiplier: 1.0, constant: 0))
//        addConstraint( NSLayoutConstraint(item: discoverMaskView, attribute: .centerY, relatedBy: .equal, toItem: circleView, attribute: .centerY, multiplier: 1.0, constant: 0))
