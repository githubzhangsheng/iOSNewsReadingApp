...
class LoginViewController: UIViewController,UITextFieldDelegate {
    ...
    @objc private func loginBtnClick() {
        ...
        if(txtUser.text == "" || txtPwd.text == "") {
            SVProgressHUD.showInfo(withStatus: "账号密码不可为空!")
            return;
        }
            ...
            switch type {
                case 0:
                    ...
                    self.dismiss(animated: false) {
                        ...
                        // 通知中心是同步的
                        NotificationCenter.default.post(name: NSNotification.Name(NewsSwitchRootViewControllerNotification), object: "welcome")
                    }
                case 1: SVProgressHUD.showError(withStatus: "网路不好!")
                case 2: SVProgressHUD.showError(withStatus: "账号或密码有误!")
                case 3: SVProgressHUD.showError(withStatus: "用户信息加载失败!")
                default: return;
            }
        }
